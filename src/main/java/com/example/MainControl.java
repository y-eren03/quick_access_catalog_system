...
public class MainControl {
    ...
    @FXML
    private TextField aramaKodField;
    @FXML
    private TextField aramaAdField;

    @FXML
    private ChoiceBox<String> filtreKategoriBox;
    @FXML
    private ChoiceBox<String> filtreMarkaBox;
    @FXML
    private TextField minFiyatField;
    @FXML
    private TextField maxFiyatField;

    @FXML
    private TextField ekleKodField;
    @FXML
    private TextField ekleAdField;
    @FXML
    private TextField ekleKategoriField;
    @FXML
    private TextField ekleMarkaField;
    @FXML
    private TextField ekleFiyatField;

    @FXML
    private StackPane ekleMenu;
    @FXML
    private Button eklemenubuton;
    @FXML
    private Label ekleMenuKapatmaLabel;

    private boolean fiyatArtanMi = true;

    @FXML
    private TableView<UrunNode> urunTablosu;
    @FXML
    private TableColumn<UrunNode, String> kodKolon, adKolon, kategoriKolon, markaKolon;
    @FXML
    private TableColumn<UrunNode, Double> fiyatKolon;
    @FXML
    private TableColumn<UrunNode, Void> silKolon;
    ...
    public void initialize() {
        ...
        fiyatButton.setStyle(
                "-fx-font-weight: bold; -fx-background-color: transparent; -fx-border-color: transparent; -fx-text-fill: white;");
    ...
    public void filtreleUrunler() {
        ...
        try {
            if (!minStr.isEmpty())
                minFiyat = Double.parseDouble(minStr);
            if (!maxStr.isEmpty())
                maxFiyat = Double.parseDouble(maxStr);
        } catch (NumberFormatException e) {
        ...
        if (seciliKategori.equals("Kategori Seçiniz") && seciliMarka.equals("Marka Seçiniz")) {
            for (UrunNode urun : hashTable.getObservableList()) {
                ...
                if (urun.fiyat < minFiyat || urun.fiyat > maxFiyat)
                    eslesiyor = false;
            ...
            for (UrunNode urun : hashTable.getObservableList()) {
                ...
                boolean eslesiyor = true;
                if (seciliKategori != null && !urun.kategori.equals(seciliKategori))
                    eslesiyor = false;
                if (urun.fiyat < minFiyat || urun.fiyat > maxFiyat)
                    eslesiyor = false;
            ...
            for (UrunNode urun : hashTable.getObservableList()) {
                ...
                boolean eslesiyor = true;
                if (seciliMarka != null && !urun.marka.equals(seciliMarka))
                    eslesiyor = false;
                if (urun.fiyat < minFiyat || urun.fiyat > maxFiyat)
                    eslesiyor = false;
